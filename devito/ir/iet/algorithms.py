...
def iet_build(stree, **kwargs):
    ...
    for i in stree.visit():
        if i == stree:
            ...
            if(ooc):
                iet_body = _ooc_build(iet_body, kwargs['sregistry'].nthreads, kwargs['profiler'], ooc.function, ooc.mode, is_mpi, time_iterator)
...
def _ooc_build(iet_body, nthreads, profiler, func, out_of_core, is_mpi, time_iterator):
    """
