...
from devito.types import (CustomDimension, Array, Pointer, Symbol, TimeDimension, SpaceDimension, off_t)
...
def open_build(filesArray, countersArray, metasArray, sptArray, offsetArray, nthreadsDim, nthreads, is_forward, iSymbol, is_compression, slices_size):
    ...
    if not is_forward and not is_compression:
        ...
        # Compression
        get_slices_size = Call(name="get_slices_size", arguments=[metasArray, sptArray], retobj=slices_size)
